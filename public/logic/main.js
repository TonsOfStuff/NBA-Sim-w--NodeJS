...
//Players
const michaelJordan = new Player("Michael Jordan", "Slasher All", 99, 90, 99, 93, 99, 99, 39, 21, 82, 97, 33, 34, 92, 32, 96, 95, 99, 99, 89, 89, 18, 17, 29, 37, 82, 79, 93, 99, 99, 52, 93, 78, 34, 48, 99, 99)
...
const magicJohnson = new Player("Magic Johnson", "Playmaker Inside", 98, 80, 97, 85, 96, 93, 47, 33, 72, 79, 62, 53, 99, 99, 94, 91, 99, 99, 92, 90, 1, 1, 2, 1, 87, 88, 99, 3, 81, 93, 90, 81, 35, 42, 98, 99);
...
const curry = new Player("Stephen Curry", "Shooter Playmaker", 99, 99, 81, 99, 99, 67, 10, 5, 22, 90, 34, 45, 87, 75, 95, 90, 88, 47, 77, 78, 90, 90, 83, 99, 61, 65, 54, 99, 62, 47, 97, 75, 34, 38, 98, 99);
...
const wemby = new Player("Victor Wembanyama", "Two-way Defensive", 97, 91, 98, 84, 97, 99, 71, 55, 99, 82, 22, 37, 83, 38, 90, 82, 98, 99, 71, 63, 80, 62, 88, 92, 99, 99, 83, 99, 53, 77, 85, 90, 42, 38, 96, 99);
...
const jokic = new Player("Nikola Jokic", "Playmaker Inside", 96, 94, 98, 79, 99, 73, 87, 62, 34, 53, 33, 50, 99, 99, 93, 77, 99, 99, 72, 80, 0, 0, 65, 82, 45, 55, 88, 90, 23, 31, 69, 83, 38, 34, 93, 99);
...
const dame = new Player("Damian Lillard", "Shooter Slasher", 92, 97, 79, 89, 93, 60, 12, 6, 24, 60, 29, 39, 82, 70, 91, 87, 86, 72, 81, 83, 90, 93, 90, 89, 66, 55, 50, 90, 65, 58, 89, 74, 33, 39, 95, 98);
...
const kevinGarnett = new Player("Kevin Garnett", "Two-way Post-player", 97, 65, 99, 80, 90, 97, 85, 84, 92, 64, 40, 35, 54, 28, 78, 84, 97, 94, 66, 69, 0, 1, 1, 0, 74, 70, 82, 0, 90, 90, 87, 83, 42, 39, 93, 97);
const manuGinobili = new Player("Manu Ginobili", "Slasher Shooter", 92, 90, 88, 84, 87, 78, 29, 18, 33, 74, 55, 40, 84, 36, 88, 87, 82, 81, 85, 86, 87, 88, 78, 79, 72, 70, 73, 78, 76, 68, 85, 78, 32, 34, 92, 93);
