...
//Players
const michaelJordan = new Player("Michael Jordan", "Slasher All", 99, 90, 99, 93, 99, 99, 39, 21, 82, 97, 53, 32, 92, 32, 96, 95, 99, 99, 99, 99, 58, 67, 79, 77, 99, 99, 99, 99, 99, 52, 93, 97, 78, 34, 48, 99, 99, 99)
const lebron = new Player("LeBron James", "All", 95, 93, 97, 76, 99, 86, 42, 21, 88, 45, 42, 35, 94, 81, 97, 99, 95, 91, 82, 87, 32, 32, 82, 85, 82, 90, 98, 95, 83, 79, 92, 95, 81, 37, 42, 99, 99, 99)
const kareem = new Player("Kareem Abdul-Jabbar", "Inside Post-player", 92, 0, 99, 73, 99, 99, 93, 87, 94, 31, 2, 30, 13, 12,57, 78, 96, 99, 42, 49, 0, 0, 0, 0, 95, 96, 62, 0, 54, 21, 78, 94, 85, 40, 40, 95, 95, 99);
const duncan = new Player("Tim Duncan", "Inside Defensive", 96, 50, 99, 80, 95, 99, 80, 90, 95, 82, 76, 35, 42, 48,52, 80, 91, 97, 96, 90, 0, 0, 1, 1, 92, 90, 97, 0, 31, 27, 76, 96, 83, 38, 39, 93, 98, 99);
const bird = new Player("Larry Bird", "All", 98, 98, 91, 94, 99, 76, 52, 21, 42, 88, 15, 39, 94, 50, 82, 90, 87, 85, 95, 99, 94, 92, 90, 67, 84, 88, 42, 83, 45, 69, 91, 90, 81, 33, 37, 99, 92, 99);
const magicJohnson = new Player("Magic Johnson", "Playmaker Inside", 98, 80, 97, 85, 96, 93, 47, 33, 72, 79, 62, 53, 99, 99, 94, 91, 99, 99, 92, 90, 1, 1, 2, 1, 87, 88, 99, 3, 81, 93, 90, 93, 81, 35, 42, 98, 89, 99);
const kobe = new Player("Kobe Bryant", "Slasher", 93, 92, 93, 90, 99, 92, 34, 22, 82, 80, 22, 21, 46, 15, 89, 88, 90, 83, 98, 73, 34, 21, 85, 88, 83, 72, 76, 77, 80, 77, 91, 87, 78, 33, 40, 99, 99, 99);
const shaq = new Player("Shaquille O'Neal", "Inside Post-player", 92, 0, 99, 55, 99, 88, 87, 80, 85, 21, 1, 28, 21, 26, 68, 92, 99, 99, 45, 43, 0, 0, 0, 0, 0, 0, 0, 0, 83, 14, 70, 92, 85, 42, 45, 95, 99, 99);
const curry = new Player("Stephen Curry", "Shooter Playmaker", 99, 99, 81, 99, 99, 67, 10, 5, 22, 90, 34, 45, 87, 75, 95, 90, 88, 47, 77, 78, 90, 90, 83, 99, 61, 65, 54, 99, 62, 47, 97, 95, 75, 34, 38, 98, 90, 99);
const hakeem = new Player("Hakeem Olajuwan", "Inside Post-player", 94, 0, 99, 78, 95, 99, 76, 76, 99, 40, 31, 38, 44, 32, 77, 79, 93, 93, 95, 90, 0, 0, 0, 0, 36, 44, 30, 0, 62, 33, 78, 91, 84, 38, 38, 93, 93, 99);
const billRussell = new Player("Bill Russell", "Defensive Post-player", 90, 0, 99, 65, 84, 99, 99, 99, 99, 80, 77, 52, 83, 43, 77, 91, 99, 99, 21, 20, 0,0, 0, 0, 10, 15, 14, 0, 82, 65, 81, 90, 82, 40, 40, 87, 80, 99);
const wilt = new Player("Wilt Chamberlain", "All Post-player", 97, 0, 99, 72, 99, 98, 99, 99, 99, 54, 21, 50, 82, 33, 88, 80, 99, 99, 87, 88, 0, 0, 0, 0, 54, 50, 33, 0, 99, 65, 94, 85, 85, 48, 36, 71, 87, 99);
const durant = new Player("Kevin Durant", "Shooter All", 98, 97, 90, 95, 97, 81, 54, 40, 77, 62, 12, 35, 47, 31, 91, 82, 93, 47, 90, 90, 32, 21, 99, 80, 76, 80, 89, 99, 76, 22, 78, 92, 83, 41, 38, 92, 92, 99);
const wemby = new Player("Victor Wembanyama", "Two-way Defensive", 97, 91, 99, 93, 97, 99, 71, 55, 99, 72, 22, 37, 53, 48, 90, 82, 98, 99, 81, 93, 70, 62, 88, 92, 99, 99, 83, 99, 53, 77, 85, 91, 90, 42, 38, 96, 99, 99);
const doncic = new Player("Luka Doncic", "All Playmakers", 98, 96, 94, 86, 99, 62, 68, 56, 12, 44, 12, 38, 98, 99, 82, 88, 92, 92, 50, 12, 95, 90, 96, 88, 91, 90, 32, 99, 42, 33, 98, 87, 78, 38, 49, 99, 99, 99);
...
const shai = new Player("Shai Gilgeous Alexander", "Slasher", 98, 90, 96, 90, 99, 83, 25, 17, 40, 80, 21, 33, 23, 14, 92, 90, 90, 83, 89, 89, 18, 17, 29, 37, 82, 79, 93, 6, 81, 66, 93, 98, 78, 36, 80, 95, 98, 99);
...
const dirk = new Player("Dirk Nowitzki", "Shooter", 96, 92, 90, 87, 97, 68, 42, 10, 70, 75, 18, 38, 42, 53, 88, 94, 92, 93, 99, 90, 13, 10, 32, 11, 56, 78, 77, 80, 32, 43, 80, 92, 84, 40, 38, 95, 91, 99);
const iverson = new Player("Allen Iverson", "Slasher Shooter", 93, 89, 87, 81, 97, 58, 15, 9, 20, 96, 58, 36, 88, 11, 99, 85, 88, 87, 90, 82, 57, 60, 79, 61, 88, 87, 85, 68, 90, 95, 90, 84, 72, 30, 38, 99, 90, 99);
const stockton = new Player("John Stockton", "Playmaker Defensive", 90, 85, 87, 86, 88, 89, 24, 18, 24, 99, 90, 50, 98, 99, 89, 83, 70, 68, 74, 73, 69, 26, 31, 53, 80, 80, 78, 72, 74, 91, 84, 83, 73, 28, 31, 95, 79, 98);
const malone = new Player("Karl Malone", "Inside Post-player", 95, 0, 99, 76, 93, 87, 68, 65, 76, 38, 22, 36, 40, 28, 77, 85, 94, 96, 75, 71, 0, 0, 0, 0, 93, 88, 94, 0, 84, 79, 89, 89, 81, 35, 38, 93, 89, 98);
const drexler = new Player("Clyde Drexler", "Slasher Two-way", 95, 89, 94, 78, 95, 84, 35, 24, 40, 81, 45, 36, 60, 67, 88, 84, 85, 83, 87, 81, 64, 68, 77, 80, 78, 80, 79, 82, 89, 87, 82, 88, 78, 36, 34, 92, 88, 97);
const isiah = new Player("Isiah Thomas", "Playmaker", 93, 81, 95, 85, 94, 79, 20, 12, 18, 93, 71, 44, 93, 95, 91, 85, 86, 84, 85, 84, 74, 76, 81, 79, 83, 84, 81, 75, 85, 88, 85, 86, 74, 32, 35, 95, 90, 97);
const pippen = new Player("Scottie Pippen", "All Defensive", 93, 88, 92, 79, 87, 98, 50, 42, 88, 88, 55, 41, 74, 50, 82, 83, 86, 85, 83, 88, 82, 80, 84, 86, 82, 85, 84, 88, 86, 90, 90, 82, 79, 33, 36, 90, 85, 98);
const moses = new Player("Moses Malone", "Inside Post-player", 90, 0, 99, 78, 97, 87, 92, 99, 68, 33, 22, 36, 30, 16, 65, 90, 99, 99, 65, 62, 0, 0, 0, 0, 94, 92, 91, 0, 87, 76, 89, 83, 84, 41, 37, 88, 90, 97);
const brunson = new Player("Jalen Brunson", "Shooter Slasher", 94, 94, 90, 89, 92, 65, 19, 10, 43, 82, 33, 38, 56, 47, 90, 98, 95, 95, 32, 34, 44, 56, 25, 92, 89, 90, 76, 88, 50, 73, 77, 83, 74, 40, 40, 97, 91, 99);
...
const reggieMiller = new Player("Reggie Miller", "Shooter", 95, 99, 70, 92, 92, 65, 24, 9, 20, 44, 22, 36, 79, 28, 82, 83, 70, 68, 89, 91, 99, 97, 84, 85, 74, 73, 76, 99, 54, 50, 84, 83, 78, 34, 34, 89, 90, 94);
...
const manuGinobili = new Player("Manu Ginobili", "Slasher Shooter", 92, 90, 88, 84, 87, 78, 29, 18, 33, 74, 55, 40, 84, 36, 88, 87, 82, 81, 85, 86, 87, 88, 78, 79, 72, 70, 73, 78, 76, 68, 85, 79, 78, 32, 34, 92, 82, 93);
...
const bamAdebayo = new Player("Bam Adebayo", "Defensive Post-player", 82, 0, 92, 78, 86, 95, 84, 88, 90, 41, 28, 35, 74, 45, 72, 81, 92, 89, 52, 50, 0, 0, 0, 0, 65, 60, 72, 0, 84, 80, 83, 79, 83, 39, 36, 89, 87, 93);
const donovanMitchell = new Player("Donovan Mitchell", "Slasher Shooter", 90, 92, 91, 85, 90, 78, 25, 20, 40, 82, 34, 36, 72, 39, 89, 83, 88, 84, 86, 88, 84, 82, 87, 85, 83, 81, 82, 87, 96, 86, 86, 90, 78, 35, 37, 94, 88, 95);
const karlAnthonyTowns = new Player("Karl-Anthony Towns", "Shooter Post-player", 92, 92, 90, 86, 89, 82, 84, 76, 85, 40, 22, 33, 66, 58, 75, 86, 94, 90, 80, 79, 60, 55, 76, 80, 74, 72, 83, 90, 80, 66, 85, 81, 84, 41, 38, 91, 88, 94);
const dejounteMurray = new Player("Dejounte Murray", "Playmaker Defensive", 87, 83, 82, 84, 86, 90, 44, 31, 58, 87, 52, 43, 88, 61, 89, 84, 80, 78, 74, 72, 48, 50, 66, 70, 72, 74, 70, 72, 85, 88, 84, 80, 80, 33, 35, 90, 85, 93);
...
const tyreseHaliburton = new Player("Tyrese Haliburton", "Playmaker Shooter", 89, 92, 82, 88, 90, 70, 30, 20, 24, 78, 36, 45, 95, 91, 90, 85, 80, 75, 83, 85, 89, 87, 88, 86, 68, 66, 72, 92, 78, 69, 85, 85, 79, 36, 38, 92, 86, 95);
const chetHolmgren = new Player("Chet Holmgren", "Two-way Defensive", 88, 88, 95, 84, 82, 90, 72, 55, 99, 80, 30, 40, 25, 10, 88, 82, 95, 95, 70, 68, 84, 80, 88, 90, 98, 99, 83, 90, 50, 75, 85, 83, 85, 42, 39, 95, 83, 99);
...
const jalenGreen = new Player("Jalen Green", "Slasher Shooter", 89, 92, 90, 84, 92, 70, 25, 18, 40, 82, 28, 36, 80, 48, 87, 82, 86, 82, 83, 85, 82, 80, 84, 82, 78, 74, 79, 86, 88, 72, 83, 73, 78, 35, 36, 91, 86, 94);
const tyreseMaxey = new Player("Tyrese Maxey", "Slasher Shooter", 88, 90, 86, 82, 89, 68, 24, 16, 38, 78, 25, 32, 78, 42, 86, 82, 84, 78, 80, 81, 78, 76, 80, 78, 74, 72, 78, 84, 84, 68, 81, 82, 77, 34, 35, 90, 85, 93);
const joshGiddey = new Player("Josh Giddey", "Playmaker Two-way", 87, 88, 84, 82, 85, 78, 36, 30, 58, 82, 32, 36, 88, 82, 85, 82, 86, 80, 78, 80, 84, 82, 85, 84, 78, 76, 80, 88, 76, 70, 83, 78, 79, 36, 38, 91, 86, 94);
...
const austinReaves = new Player("Austin Reaves","Shooter Playmaker",93,94,90,87,92,61,65,60,35,65,60,55,82,78,84,80,76,75,78,79,84,83,80,81,74,73,77,82,74,78,83,85,77,28,32,88,89,92);
...
const zionWilliamson = new Player("Zion Williamson","Slasher Post-player",92,70,95,75,88,80,82,70,65,60,55,62,74,68,82,90,92,88,70,72,40,38,60,58,86,84,78,62,98,88,76,89,79,42,45,90,85,94);
const dariusGarland = new Player("Darius Garland","Shooter Playmaker",87,90,80,85,86,70,60,55,38,72,65,60,88,82,85,83,80,78,82,81,90,89,84,85,76,75,80,88,80,78,84,78,77,30,34,89,83,92);
...
const isiahJoe = new Player("Isiah Joe","Shooter",88,92,80,85,87,60,20,15,30,55,15,53,25,5,78,82,76,70,10,12,88,45,40,78,20,25,30,90,70,50,79,75,76,31,20,85,63,94);
const ajayMitchell = new Player("Ajay Mitchell","Shooter Slasher",88,90,86,82,88,70,25,18,40,82,28,48,30,18,87,82,56,62,73,85,82,80,34,32,18,24,59,86,88,72,83,76,76,35,36,91,86,91);
const isaiahHartenstein = new Player("Isaiah Hartenstein","Inside Post-player",87,80,91,68,77,82,80,75,82,38,22,50,10,28,45,72,88,96,10,18,5,1,5,3,2,1,8,2,64,60,73,78,84,45,38,82,73,91);
const cadeCunningham = new Player("Cade Cunningham","Playmaker Slasher",93,88,94,88,91,70,64,22,43,77,28,39,92,90,82,80,86,82,78,80,84,82,85,84,78,76,80,86,88,72,83,86,78,32,42,91,85,95);
const jalenDuren = new Player("Jalen Duren","Inside Post-player",87,60,95,75,81,92,82,70,83,60,15,40,34,18,62,90,99,88,27,31,0,1,1,3,32,12,3,12,98,88,81,79,82,42,35,90,85,94);
const derrickWhite = new Player("Derrick White","Defensive Playmaker",88,85,90,83,81,89,33,31,89,82,49,48,70,12,77,78,90,28,10,22,50,52,76,78,38,15,20,89,65,93,80,80,76,43,35,80,73,92);
const paoloBanchero = new Player("Paolo Banchero","Two-way Post-player",94,85,90,81,90,73,56,43,72,33,30,38,40,40,78,83,97,92,70,72,30,38,38,42,46,34,78,32,91,68,84,82,82,45,39,88,83,95);
...
const trailblazers = new Team("Portland Trail Blazers", false, "POR", [dame, drexler, scootHenderson, luDort]);
...
export async function load(){
    ...
    const players = playerData.map(p => {
        const player = new Player(
            ...
            p.hustle, p.stamina, p.consistency, p.height, p.foul, p.drawFoul, p.clutch, p.usageAtt, p.potential
        );
...
function subbing(quarter, time, team1, team2, possesion, insertStart = false){
    ...
    if (insertStart === false && Math.random() * 10 <= 1){
        insertStart = true;
    }
